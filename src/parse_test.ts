...
Deno.test({
  ...
  fn() {
    const spec: Command = {
      name: "test",
      flags: [{ name: "--arg", args: { name: "optionarg" } }],
      args: [{ name: "arg1" }, { name: "arg2" }],
    };
...
Deno.test({
  ...
  fn() {
    const spec: Command = {
      name: "test",
      flags: [{ name: "-a" }, { name: "-b", args: {} }, { name: "-c" }],
    };
    const result = parse(["-abc"], spec);
    const wantOptions = makeMap({
      "-a": [],
...
Deno.test({
  ...
  fn() {
    ...
    const spec: Command = {
      name: "test",
      flags: [{ name: "--top", isPersistent: true }],
      subcommands: [command],
    };
...
Deno.test({
  ...
  fn() {
    const spec: Command = {
      name: "test",
      flags: [{ name: "--persistent", isPersistent: true }],
      subcommands: [{ name: "command" }],
    };
...
Deno.test({
  ...
  fn() {
    const spec: Command = {
      name: "command",
      flags: [{ name: ["-r", "--rep"], isRepeatable: true }],
    };
...
Deno.test({
  ...
  fn() {
    const spec: Command = {
      name: "command",
      flags: [{ name: ["-r", "--rep"], isRepeatable: 2 }],
    };
...
Deno.test({
  ...
  fn() {
    const spec: Command = {
      name: "command",
      flags: [{ name: "--sep", requiresSeparator: true, args: {} }],
      args: { isOptional: true },
    };
...
Deno.test({
  ...
  fn() {
    const spec: Command = {
      ...
      flags: [{ name: "--sep", requiresSeparator: ":", args: {} }],
    };
...
Deno.test({
  ...
  fn() {
    const spec: Command = {
      name: "command",
      flags: [{ name: "-a", exclusiveOn: ["-b"] }, { name: "-b" }],
    };
    parse(["-a"], spec);
    parse(["-b"], spec);
    assertThrows(() => {
...
Deno.test({
  ...
  fn() {
    const spec: Command = {
      name: "command",
      flags: [{ name: "-a", dependsOn: ["-b"] }, { name: "-b" }],
    };
    assertThrows(() => {
      parse(["-a"], spec);
    });
...
Deno.test({
  ...
  fn() {
    const spec: Command = {
      name: "command",
      flags: [{ name: "--angry", isRequired: true }],
    };
    assertThrows(() => {
      parse([], spec);
    });
...
Deno.test({
  ...
  fn() {
    const spec: Command = {
      name: "command",
      flags: [{ name: "--angry", isRequired: true, isPersistent: true }],
